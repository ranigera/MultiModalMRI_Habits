% Programmed with Psychtoolbox 3.0.12 on Matlab 2014b

% Codes adapted from other versions to be used for the Neuroimage registered report study:

% Characterizing habit learning in the human brain at the individual and group levels: a multi-modal MRI study

% Rani Gera1,2,3, Ido Tavor1,4, Jeffrey Cockburn5, Segev Barak1,2, Elizabeth Tricomi6, John P. O?Doherty5,7 and Tom Schonberg1,3*
