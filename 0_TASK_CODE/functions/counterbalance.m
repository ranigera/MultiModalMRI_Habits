function [var, data] = counterbalance(var, data)
...
if ~isfield(var, 'runs') % an indicator that it is outside the MRI, i.e., PRACTICE!
    randFractalOrder = Shuffle(1:3);
    randButtonOrder  = Shuffle(1:2);
    var.sweet_fractal_demo        = imread(['images/fractal_demo' num2str(randFractalOrder(1)) '.jpg']);
    var.salty_fractal_demo        = imread(['images/fractal_demo' num2str(randFractalOrder(2)) '.jpg']);
    var.rest_fractal_demo         = imread(['images/fractal_demo' num2str(randFractalOrder(3)) '.jpg']);
    if randButtonOrder(1) == 1
        var.sweet_action_demo = var.leftKey;       var.sweet_square_pos_demo     = var.square3;
        var.salty_action_demo = var.centerLeftKey; var.salty_square_pos_demo     = var.square4;
    else
        var.sweet_action_demo = var.centerLeftKey; var.sweet_square_pos_demo     = var.square4;
        var.salty_action_demo = var.leftKey; var.salty_square_pos_demo     = var.square3;
    end
end
