...
if isfield(var, 'runs') % as an indicator of running in the MRI code
    escapeKey = [var.rightKey];
    leftKey = var.leftKey;   % former 'LeftArrow'
    rightKey = var.centerLeftKey; % former 'RightArrow'
else
...
while exitDemo == false
    ...
    if isfield(var, 'runs') % as an indicator of running in the MRI code
        DrawFormattedText(var.w, [1500 1495 1510 47 1497 32 1506 1500 32 1492 1502 1511 1513 32 1513 1506 1500 1497 1493 32 1502 1502 1493 1511 1502 1514 32 1492 1494 1512 1514 32 1499 1491 1497 32 1500 1488 1513 1512], 'center', RectHeight(var.rect) - 3*forty);
    else
