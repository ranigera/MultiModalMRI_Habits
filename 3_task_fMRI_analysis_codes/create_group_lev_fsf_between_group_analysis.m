function create_group_lev_fsf_between_group_analysis(model_name, analysis_name, lev1CopeNum, variance_equality, region)
...
if rewrite_launchfiles
    launchfile_to_delete = fullfile(launchdir,['group_model' model_name '_' analysis_name '_' variance_equality '_based-on-' onsetsOrWholeBlocks '_' region '_launch.txt']);
...
targetFilePath=fullfile(fsfdir, ['design_group_model-' model_name '_' analysis_name '_' variance_equality '_based-on-' onsetsOrWholeBlocks '_' region '.fsf']);
...
if ~exist(targetFilePath, 'file') || rewrite_fsfs || rewrite_launchfiles
    ...
    launchFilePath = fullfile(launchdir, ['group_model' model_name '_' analysis_name '_' variance_equality '_based-on-' onsetsOrWholeBlocks '_' region '_launch.txt']);
