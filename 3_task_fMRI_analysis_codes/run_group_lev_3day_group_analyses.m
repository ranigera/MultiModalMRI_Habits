function run_group_lev_3day_group_analyses(model, analysis_name, lev1CopeNum, region)
...
file = ['group_model' model '_' analysis_name '_based-on-' onsetsOrWholeBlocks '_' region '_launch.txt'];

%% input check:
% ------------------------------
if nargin < 1
    error('The function requires 3 input arguments: model, analysis_name, region.')
end
