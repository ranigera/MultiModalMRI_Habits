function create_group_lev_fsf_individual_diff_across_all(model_name, analysis_name, lev1CopeNum, region)
...
if rewrite_launchfiles
    launchfile_to_delete = fullfile(launchdir,['group_model' model_name '_individual-differences_across-all_' analysis_name '_based-on-' onsetsOrWholeBlocks '_' region '_launch.txt']);
...
targetFilePath=fullfile(fsfdir, ['design_group_model-' model_name '_individual-differences_across-all_' analysis_name '_based-on-' onsetsOrWholeBlocks '_' region '.fsf']);
...
if ~exist(targetFilePath, 'file') || rewrite_fsfs || rewrite_launchfiles
    ...
    launchFilePath = fullfile(launchdir, ['group_model' model_name '_individual-differences_across-all_' analysis_name '_based-on-' onsetsOrWholeBlocks '_' region '_launch.txt']);
