function run_group_lev_between_group_analysis2(model, analysis_name, lev1CopeNum, variance_equality, region)
...
file = ['noFieldMapParticipants_group_model' model '_' analysis_name '_' variance_equality '_based-on-' onsetsOrWholeBlocks '_' region '_launch.txt'];
