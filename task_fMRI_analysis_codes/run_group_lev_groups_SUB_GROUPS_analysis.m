function run_group_lev_groups_SUB_GROUPS_analysis(model, analysis_name, lev1CopeNum, group, variance_equality, region)
...
file = ['group_model' model '_' group '_SubGroups_' analysis_name '_' variance_equality '_based-on-' onsetsOrWholeBlocks '_' region '_launch.txt'];
...
system(command)
disp(['** Sending the requested group level launch files of "SUBGROUPS of ' group ' - ' analysis_name ' - ' variance_equality ' - ' region '" for execution COMPLETED'])
